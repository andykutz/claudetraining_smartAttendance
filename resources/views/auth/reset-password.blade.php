<x-guest-layout>
    <div class="mb-6">
        <h1 class="text-xl font-semibold text-neutral-900 dark:text-white">{{ __('Reset Password') }}</h1>
        <p class="mt-1 text-sm text-neutral-500 dark:text-neutral-400">{{ __('Choose a new password for your account.') }}</p>
    </div>
